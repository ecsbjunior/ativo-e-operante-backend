...
public class ComplaintRestController {
	...
	public ResponseEntity<Object> getComplaints(@RequestParam(required=false) String user_id) {
	...
	public ResponseEntity<Object> getComplaint(@PathVariable String id) {
		HashMap<String, Complaint> map = new HashMap<String, Complaint>();
	...
	public String createComplaint(@RequestParam String title, @RequestParam String description, @RequestParam String urgency, @RequestParam String user_id, @RequestParam String competentorgan_id, @RequestParam String problemtype_id/*, @RequestParam(required=false) MultipartFile[] files*/) {
		boolean ans = true;
